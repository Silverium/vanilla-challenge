 ...
 */
export const removeAppToHostsPlugin = (list: AppData[], rankedAppsByHost: RankedAppsByHost, hostAppEntryGarbager: Function) => {
   ...
   */
  const removeAppToHosts = (appData: AppData) => {
